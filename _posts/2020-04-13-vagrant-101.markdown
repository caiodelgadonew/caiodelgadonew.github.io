...
<!--kg-card-end: markdown--><figure class="kg-card kg-image-card kg-card-hascaption"><img src="content/images/2020/04/image-57.png" class="kg-image" alt loading="lazy"><figcaption>$ vagrant status</figcaption></figure>
...
<!--kg-card-end: markdown--><figure class="kg-card kg-image-card kg-card-hascaption"><img src="content/images/2020/04/image-58.png" class="kg-image" alt loading="lazy"><figcaption>$ vagrant ssh &lt;machine&gt; -c "cat /etc/*release" </figcaption></figure>
...
<!--kg-card-end: markdown--><figure class="kg-card kg-image-card kg-card-hascaption"><img src="content/images/2020/04/image-60.png" class="kg-image" alt loading="lazy"><figcaption>$ vagrant ssh master -c "docker node ls"</figcaption></figure>
