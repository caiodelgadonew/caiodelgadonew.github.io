...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-41.png" class="kg-image" alt loading="lazy"><figcaption>$ vault operator unseal</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-42.png" class="kg-image" alt loading="lazy"><figcaption>$ vault operator unseal</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-43.png" class="kg-image" alt loading="lazy"><figcaption>$ vault operator init</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-44.png" class="kg-image" alt loading="lazy"><figcaption>$ vault login</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-45.png" class="kg-image" alt loading="lazy"><figcaption>$ vault status</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-46.png" class="kg-image" alt loading="lazy"><figcaption>$ vault login $VAULT_TOKEN</figcaption></figure>
...
<!--kg-card-end: markdown--><figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-47.png" class="kg-image" alt loading="lazy"><figcaption>creating storage path</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-48.png" class="kg-image" alt loading="lazy"><figcaption>$ vault kv list blog</figcaption></figure>

Para acessar um secret utilizamos o comando `vault kv get <path>/<secret>`.

<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-49.png" class="kg-image" alt loading="lazy"><figcaption>$ vault kv get blog/caiodelgado</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-50.png" class="kg-image" alt loading="lazy"><figcaption>$ vault kv list blog</figcaption></figure>

Para verificar o conteúdo do subpath basta informar o mesmo no comando para listagem.

<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-51.png" class="kg-image" alt loading="lazy"><figcaption>$ vault kv list blog/caiodelgado/</figcaption></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="/docs/assets/2020/04/image-52.png" class="kg-image" alt loading="lazy"><figcaption>$ vault kv get blog/caiodelgado/data</figcaption></figure>
